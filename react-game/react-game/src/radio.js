window.onload = () => {
	...
	var rad_backcolor="#6c757d"; var rad_logo = "white"; var rad_autoplay = false; var rad_width = "fixed"; var rad_width_px = 350;var rad_stations =[['http://shoutcast.aplus.by:9000/aplus_rock_128','Радио Аплюс Рок','aplusrock'],['http://europaplus.hostingradio.ru:8014/retro320.mp3','Ретро FM','retrofmrus'],['http://ic7.101.ru:8000/a101?userid=0','Радио Романтика','romantika'],['http://radio-electron.ru:8000/192','Радио Электрон','electron']];
